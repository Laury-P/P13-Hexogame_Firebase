...
sealed class FormEvent {
    ...
    /**
     * Event triggered when a photo is selected from the gallery.
     *
     * @property uri The URI of the selected photo.
     */
...
sealed class FormError(@StringRes val messageRes: Int) {
     ...
     */
    data object DescriptionOrPhotoError : FormError(R.string.error_photo_or_description)
